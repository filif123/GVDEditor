...
#pragma warning restore 1591
        ...
        /// <summary>Returns a value that indicates whether the values of two <see cref="T:GVDEditor.Entities.ReportVariant" /> objects are equal.</summary>
        ...
        /// <summary>Returns a value that indicates whether two <see cref="T:GVDEditor.Entities.ReportVariant" /> objects have different values.</summary>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>

...
namespace GVDEditor.XML
{
    ...
    public class DesktopColumns
    {
        ...
        /// </summary>
        [XmlElement("DateRem")] public DesktopColumn DateRem = new() {Order = 10, Visible = true, MinWidth = 300};
        ...
        public List<DesktopColumn> GetValues()
        {
            return new()
            {
                ...
                KonecnaStanica, DateRem, Track, Operator, OtherBtn
            };
        }

        /// <summary>
        ///     Vráti zoradený zoznam všetkých možnźch stĺpcov pre tabuľku na pracovnej ploche programu
        /// </summary>
        /// <returns></returns>

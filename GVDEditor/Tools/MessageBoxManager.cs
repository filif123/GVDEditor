...
namespace GVDEditor.Tools
{
    ...
    internal static class MessageBoxManager
    {
        ...
        ///     OK text
        /// </summary>
        [Localizable(true)] public static string OK = @"&OK";

        /// <summary>
        ///     Cancel text
        /// </summary>
        [Localizable(true)] public static string Cancel = @"&Cancel";

        /// <summary>
        ///     Abort text
        /// </summary>
        [Localizable(true)] public static string Abort = @"&Abort";

        /// <summary>
        ///     Retry text
        /// </summary>
        [Localizable(true)] public static string Retry = @"&Retry";

        /// <summary>
        ///     Ignore text
        /// </summary>
        [Localizable(true)] public static string Ignore = @"&Ignore";

        /// <summary>
        ///     Yes text
        /// </summary>
        [Localizable(true)] public static string Yes = @"&Yes";

        /// <summary>
        ///     No text
        /// </summary>
        [Localizable(true)] public static string No = @"&No";
